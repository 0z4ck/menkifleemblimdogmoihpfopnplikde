(function() {
        ...
        Jb = function(a, b) {
            ...
            if (!nb) {
                ...
                if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                    ...
                    for (l = 0; !c.X && l < e.length; l++) c.currentTarget = e[l],
                    D = Pb(e[l], f, !1,
                        c),
                    d = d && D
                }
    ...
    h.dispatchEvent = function(a) {
        ...
        var e = !0,
            f;
        if (b)
            for (var g = b.length - 1; !a.X && 0 <= g; g--) f = a.currentTarget = b[g], e = Rb(f, d, !0, a) && e;
        a.X || (f = a.currentTarget = c, e = Rb(f, d, !0, a) && e, a.X || (e = Rb(f, d, !1, a) && e));
        if (b)
            for (g = 0; !a.X && g < b.length; g++) f = a.currentTarget = b[g], e = Rb(f, d, !1, a) && e;
        return e
    };
    h.o = function() {
        M.P.o.call(this);
    ...
    var Ac = function(a) {
        ...
        wc = function(a) {
            ...
            a.D = b;
            d && (l = t(a.qb, a, !0), d = t(a.qb, a, !1), b instanceof Q ? (zc(b, l, d), b.Xb = !0) : b.then(l, d));
    ...
    var vd = function(a, b, c, d, e, f) {
        if (n(c))
            for (var g = 0; g < c.length; g++) vd(a, b, c[g], d, e, f);
        else {
